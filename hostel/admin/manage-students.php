...
$ret = "SELECT r.*, c.course_fn
        FROM registration r
        JOIN courses c ON r.course = c.course_fn";
...
<td>
<a href="javascript:void(0);"  onClick="popUpWindow('http://localhost/hostelsystem/hostel/admin/full-profile.php?id=<?php echo $row->id;?>');" title="View Full Details"><i class="fa fa-desktop"></i></a>&nbsp;&nbsp;
